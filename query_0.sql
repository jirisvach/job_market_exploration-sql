...
-- copy cvs files into the database
COPY company_dim
FROM 'W:\sql\sql_job_project\csv_files\company_dim.csv' WITH (
        FORMAT csv,
        HEADER true,
        DELIMITER ',',
        ENCODING 'UTF8'
...
COPY skills_dim
FROM 'W:\sql\sql_job_project\csv_files\skills_dim.csv' WITH (
        FORMAT csv,
        HEADER true,
        DELIMITER ',',
        ENCODING 'UTF8'
...
FROM 'W:\sql\sql_job_project\csv_files\job_postings_fact.csv' WITH (
        FORMAT csv,
        HEADER true,
        DELIMITER ',',
        ENCODING 'UTF8'
...
COPY skills_job_dim
FROM 'W:\sql\csv_files\skills_job_dim.csv' WITH (
        FORMAT csv,
        HEADER true,
        DELIMITER ',',
        ENCODING 'UTF8'
